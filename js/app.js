...
function startMap() {
  ...
  for (const s of SPOTS) {
    const icon = L.divIcon({ className: 'marker-wrap', iconSize: [22, 22], iconAnchor: [11, 11],
...
if (q.has('nointro') || reduced) { introWrap.remove(); title.classList.add('now'); title.classList.add('on'); startMap(); }
else {
